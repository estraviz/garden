...
The book analyzes the well-known slogan _"Follow your passion"_. Two ideas that question it:
...
2. There are no compelling reasons to support that following your passion works:
   ...
   - second, because making that a professional career and an interest that we have (= _passion_?) go hand in hand does not guarantee a successful career, nor that we will feel fulfilled with it.
